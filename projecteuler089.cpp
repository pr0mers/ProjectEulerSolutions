...
int main(){
    ...
    for(int n=0;n<dizi.size();n++){
        ...
        for(int i=0;i<s.size();i++){    
            ...
            top=top+mp[s.substr(i,1)];
        }
        kls=kls + s.size()-yap(top);
    }
    cout<<kls;
}  